...
def main():
    today = pd.Timestamp(datetime.now(timezone.utc) - timedelta(hours=5)).normalize()
    ...
    # model coefficients learned offline (2022-2024 training)
    # elo_diff, h_rest, a_rest, h_b2b, a_b2b  -> standardized
